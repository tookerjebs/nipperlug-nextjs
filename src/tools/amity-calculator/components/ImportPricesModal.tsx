/**
 * Import Prices Modal Component for Amity Calculator
 * Reuses the same import functionality as Chloe Calculator
 */
        ...
        <div className="space-y-4">
          ...
          <div className="text-sm text-gray-300">
            ...
            <p className="mt-2 text-blue-400">
              💡 Prices are shared across all calculators (Chloe, Devil Shop, and Amity)
            </p>
          </div>
