          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
            ...
            <div className="glass-panel">
              ...
              <div className="p-4 space-y-3">
                ...
                {normalDamageUp > 0 && (
                  <StepRow 
                    step="5. Normal Damage Up" 
                    minValue={normalDamageWithNormalUp} 
                    maxValue={normalDamageWithNormalUp}
                ...
                {addDamage > 0 && (
                  <StepRow 
                    ...
                    formula={`${formatNumber(Math.round(normalDamageUp > 0 ? normalDamageWithNormalUp : defenseAdjustedDamage))} + ${formatNumber(addDamage)}`}
                  />
                )}
