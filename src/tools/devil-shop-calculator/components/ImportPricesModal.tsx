/**
 * Import Prices Modal Component for Devil Shop Calculator
        ...
        <div className="space-y-4">
          ...
          <div className="text-sm text-gray-300">
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-400">
              <li><code>{"{ \"Item Name\": price, \"Devil's Token(High)\": price2 }"}</code></li>
              <li><code>{"{ \"timestamp\": \"...\", \"prices\": { \"Item Name\": price } }"}</code></li>
            </ul>
            <p className="mt-2 text-yellow-300 text-xs">
              💡 <strong>Tip:</strong> Include "Devil's Token(High)" and "Devil's Token(Highest)" in your JSON to set token prices automatically!
            </p>
          </div>
